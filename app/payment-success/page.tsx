      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-600 via-blue-700 to-blue-800 relative overflow-hidden">
        ...
        <div className="absolute top-8 left-1/2 transform -translate-x-1/2 z-20">
          <div className="relative">
            <div className="w-20 h-20 bg-white/10 backdrop-blur-xl rounded-2xl flex items-center justify-center shadow-2xl border border-white/20">
              <Image 
                src="/favicon.ico" 
            ...
            <div className="relative">
              ...
              <div className="relative bg-white/95 backdrop-blur-2xl rounded-3xl shadow-2xl p-12 border border-white/20">
                <div className="text-center">
                  ...
                  <h1 className="text-4xl font-black mb-6 text-blue-600 tracking-tight">Loading...</h1>
                  <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-2xl p-6 mb-8 border border-gray-200/50">
                    <p className="text-xl text-gray-800 mb-2 font-semibold">Processing your information</p>
                    <p className="text-gray-600 leading-relaxed">Please wait while we verify your transaction details.</p>
                  </div>
                </div>
              </div>
            </div>
