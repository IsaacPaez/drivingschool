              ...
              <div className="flex flex-col md:flex-row gap-8">
                ...
                <div className="w-full md:w-1/2 bg-white p-6 rounded-lg shadow-lg border border-gray-200">
                  ...
                  <div className="text-gray-700 mb-4">
                    <p><strong>Phone:</strong> <span className="text-blue-600 font-bold">561 330 7007</span></p>
                    <p><strong>Email:</strong> <a href="mailto:info@drivingschoolpalmbeach.com" className="text-blue-600 underline">info@drivingschoolpalmbeach.com</a></p>
                    <p><strong>Address:</strong> 3167 Forest Hill Blvd, West Palm Beach, Florida 33406</p>
                  </div>
                  ...
                  <button className="mt-8 w-full bg-blue-600 text-white font-semibold py-3 rounded-lg hover:bg-blue-700 transition">Book Now</button>
                </div>
              </div>

              <div className="text-center mt-10">
                <button onClick={() => setShowZones(!showZones)} className="text-blue-600 underline text-lg font-semibold">
              ...
              <div className="p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="p-5 bg-gray-50 rounded-lg shadow-md border border-gray-200">
                    <h3 className="text-xl font-semibold text-gray-900 mb-2 flex items-center gap-2">📍 Location Info</h3>
                    <p className="flex items-center gap-2 text-gray-800">
                      <span className="text-red-600">📞</span>
                      <strong>Phone:</strong> <a href="tel:5613307007" className="text-blue-600 hover:underline">561 330 7007</a>
                    </p>
                    <p className="flex items-center gap-2 text-gray-800">
